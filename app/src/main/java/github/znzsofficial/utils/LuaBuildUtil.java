...
import com.nwdxlgzs.AxmlEditor.AxmlEditor;
...
public class LuaBuildUtil {
  ...
  public Uri getUriForFile(File path) {
    return FileProvider.getUriForFile(mContext, mContext.getPackageName(), path);
  }
    ...
    try {
      ...
      while (es.hasMoreElements()) {
        ...
        if (z.getName().equals("AndroidManifest.xml")) {
          ...
          try {
            AxmlEditor axml = new AxmlEditor(apkZipFile.getInputStream(z));
