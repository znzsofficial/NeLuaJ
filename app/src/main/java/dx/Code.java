...
import static dx.rop.code.Rop.BRANCH_GOTO;
import static dx.rop.code.Rop.BRANCH_NONE;
import static dx.rop.code.Rop.BRANCH_RETURN;
import static dx.rop.type.Type.BT_BYTE;
import static dx.rop.type.Type.BT_CHAR;
import static dx.rop.type.Type.BT_INT;
import static dx.rop.type.Type.BT_SHORT;
...
import dx.rop.code.PlainCstInsn;
...
import dx.rop.code.ThrowingInsn;
...
public final class Code {
    ...
    private final SourcePosition sourcePosition = SourcePosition.NO_INFO;
