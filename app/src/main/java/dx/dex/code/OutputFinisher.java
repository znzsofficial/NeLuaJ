...
public final class OutputFinisher {
    ...
    private static void assignIndices(CstInsn insn,
        ...
        if (cst instanceof CstMemberRef member) {
    ...
    private boolean fixBranches() {
        ...
        for (int i = 0; i < size; i++) {
            DalvInsn insn = insns.get(i);
            if (!(insn instanceof TargetInsn target)) {
            ...
            if (opcode.getFamily() == Opcodes.GOTO) {
                 ...
                 */
                CodeAddress newTarget = getCodeAddress(i);
                TargetInsn gotoInsn =
    ...
    private CodeAddress getCodeAddress(int i) {
