    ...
    private static class Data {
        ...
        public String toHuman() {
            ...
            if (smallestSize == largestSize) {
                sb.append("    ").append(smallestSize).append(" bytes/item\n");
            } else {
                int average = totalSize / count;
                sb.append("    ").append(smallestSize).append("..").append(largestSize).append(" bytes/item; average ").append(average).append("\n");
            }
