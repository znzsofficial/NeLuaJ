...
import static dx.rop.annotation.AnnotationVisibility.SYSTEM;
...
public final class AnnotationUtils {
    ...
    public static Annotation makeSignature(CstString signature) {
        ...
        ArrayList<String> pieces = getStrings(rawLength, raw);
    ...
    @NonNull
    private static ArrayList<String> getStrings(int rawLength, String raw) {
