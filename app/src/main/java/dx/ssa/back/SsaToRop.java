...
import dx.ssa.BasicRegisterMapper;
import dx.ssa.PhiInsn;
import dx.ssa.RegisterMapper;
import dx.ssa.SsaBasicBlock;
import dx.ssa.SsaInsn;
import dx.ssa.SsaMethod;
import dx.util.Hex;
...
public class SsaToRop {
    ...
    private void removeEmptyGotos() {
        ...
        ssaMeth.forEachBlockDepthFirst(false, (b, parent) -> {
    ...
    public int[] getRegistersByFrequency() {
        ...
        Arrays.sort(ret, (o1, o2) -> ssaMeth.getUseListForRegister(o2).size()
