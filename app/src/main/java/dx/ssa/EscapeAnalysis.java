...
import dx.rop.code.Exceptions;
import dx.rop.code.FillArrayDataInsn;
...
public class EscapeAnalysis {
     ...
     */
    private void run() {
        ssaMeth.forEachBlockDepthFirstDom((block, unused) -> block.forEachInsn(new SsaInsn.Visitor() {
