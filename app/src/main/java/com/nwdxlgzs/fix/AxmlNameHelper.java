...
public class AxmlNameHelper {
	...
	static {
		...
		mAxmlNameMap.put(0x010104cf, AxmlName.platformBuildVersionCode);
		mAxmlNameMap.put(0x010104d0, AxmlName.platformBuildVersionName);
		mAxmlNameMap.put(0x010104d1, AxmlName.compileSdkVersion);
		mAxmlNameMap.put(0x010104d2, AxmlName.compileSdkVersionCodename);
	}
