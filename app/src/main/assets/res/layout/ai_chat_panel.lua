...
return {
  ...
  -- 消息列表（FrameLayout 包裹以承载“跳到最新”悬浮按钮）
  {
    FrameLayout,
    layout_width = "match",
    layout_height = "0dp",
    ...
    },
    {
      MaterialButton,
      id = "btnJumpLatest",
      contentDescription = res.string.ai_jump_latest,
      styleAttr = "?attr/materialIconButtonStyle",
      layout_width = "42dp",
      layout_height = "42dp",
      ...
      visibility = 8,
      BackgroundTintList = ColorStateList.valueOf(ColorPrimaryContainer),
      icon = res.drawable("s_down"),
      iconTint = ColorStateList.valueOf(ColorOnPrimaryContainer),
      RippleColor = ColorStateList.valueOf(ColorRipple),
      cornerRadius = "21dp",
    },
  },
